function [XB,A,B,SSE,varexpl, SSE_array, variance_array]=PCHA_PDHG(X,noc,I,U,delta,varargin)
...
%     [A,SSE,muA,AAt]=Supdate(A,XBtX,BtXtXB,muA,SST,SSE,25);
    [A,SSE] = update_A(A,X(:,U),XB,SST, noc);
end
...
% hold off;
% AA_Figure('FIGURES/PDHG/SQUARE/CBCL_PDHG_INITIAL_r100005_step20_iter1000', 19, 19, noc, XB, A);
...
%     [B,SSE,muB,mualpha,BtXtXB,XB]=Cupdate(X(:,I),XAt,XB,AAt,B,delta,muB,mualpha,SST,SSE,10);
    ...
    B = update_B(B,A,X,XtX,r1,r2,steps, noc);
    XB = X*B;
